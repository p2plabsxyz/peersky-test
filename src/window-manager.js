      ...
      try {
        ...
        (() => {
          try {
            ...
            const stored = localStorage.getItem("peersky-test-tabs");
      ...
      if (!this.window.isDestroyed() && !this.window.webContents.isDestroyed()) {
        ...
        (function() {
          try {
            ...
            const existingData = localStorage.getItem('peersky-test-tabs');
            let allTabsData = {};
            ...
            // Save merged data
            localStorage.setItem('peersky-test-tabs', JSON.stringify(allTabsData));
