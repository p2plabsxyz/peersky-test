...
Check our p2p apps in `/pages/p2p/`: https://github.com/p2plabsxyz/peersky-test/tree/main/src/pages/p2p
...
**Example:** See [p2pmd](https://github.com/p2plabsxyz/peersky-test/tree/main/src/pages/p2p/p2pmd) for a complete real-time collaborative markdown editor implementation.
